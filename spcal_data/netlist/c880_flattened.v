...
OA221x2_ASAP7_75t_R U242 ( .A1(n172), .A2(n250), .B1(n251), .B2(n252), .C( n181), .Y(n348) );
...
OA221x2_ASAP7_75t_R U247 ( .A1(n242), .A2(n243), .B1(n244), .B2(n245), .C( n142), .Y(n241) );
OA221x2_ASAP7_75t_R U248 ( .A1(n169), .A2(n310), .B1(n198), .B2(n279), .C( n207), .Y(n297) );
...
OA22x2_ASAP7_75t_R U261 ( .A1(n172), .A2(n211), .B1(n204), .B2(n260), .Y( n347) );
...
AO22x2_ASAP7_75t_R U265 ( .A1(n219), .A2(N106), .B1(N152), .B2(N138), .Y( n274) );
...
AO22x2_ASAP7_75t_R U272 ( .A1(n264), .A2(N219), .B1(n195), .B2(N237), .Y( n261) );
BUFx6f_ASAP7_75t_R U273 ( .A(n201), .Y(n321) );
INVx4_ASAP7_75t_R U274 ( .A(n321), .Y(n167) );
AO22x2_ASAP7_75t_R U275 ( .A1(n308), .A2(N219), .B1(n309), .B2(N228), .Y( n306) );
AO22x2_ASAP7_75t_R U276 ( .A1(n235), .A2(n248), .B1(n174), .B2(N165), .Y( n267) );
...
AOI22x1_ASAP7_75t_R U283 ( .A1(n296), .A2(N237), .B1(n144), .B2(N246), .Y( n285) );
INVx6_ASAP7_75t_R U284 ( .A(n175), .Y(n296) );
XOR2x2_ASAP7_75t_R U285 ( .A(n309), .B(n179), .Y(n308) );
AOI22x1_ASAP7_75t_R U286 ( .A1(N210), .A2(N121), .B1(N267), .B2(N255), .Y( n315) );
...
O2A1O1Ixp5_ASAP7_75t_R U291 ( .A1(n180), .A2(n245), .B(n243), .C(n137), .Y( n323) );
AND3x4_ASAP7_75t_R U292 ( .A(n230), .B(n238), .C(n237), .Y(n234) );
OA22x2_ASAP7_75t_R U293 ( .A1(n162), .A2(n304), .B1(n135), .B2(n194), .Y( n276) );
...
AO221x2_ASAP7_75t_R U297 ( .A1(N228), .A2(n254), .B1(N219), .B2(n255), .C( n256), .Y(n253) );
...
AOI22xp5_ASAP7_75t_R U302 ( .A1(n232), .A2(N219), .B1(n182), .B2(N246), .Y( n228) );
BUFx6f_ASAP7_75t_R U303 ( .A(n263), .Y(n210) );
INVx6_ASAP7_75t_R U304 ( .A(n210), .Y(n183) );
AO222x2_ASAP7_75t_R U305 ( .A1(N210), .A2(N106), .B1(N246), .B2(n193), .C1( N183), .C2(n133), .Y(n307) );
AO221x2_ASAP7_75t_R U306 ( .A1(n237), .A2(n238), .B1(n230), .B2(n214), .C( n195), .Y(n236) );
NAND2x1p5_ASAP7_75t_R U307 ( .A(N177), .B(n183), .Y(n266) );
AO222x2_ASAP7_75t_R U308 ( .A1(N260), .A2(N255), .B1(N195), .B2(n133), .C1( N210), .C2(N116), .Y(n287) );
AO222x2_ASAP7_75t_R U309 ( .A1(N210), .A2(N101), .B1(N246), .B2(n183), .C1( N177), .C2(n133), .Y(n262) );
AO222x2_ASAP7_75t_R U310 ( .A1(N259), .A2(N255), .B1(N246), .B2(n221), .C1( N210), .C2(N111), .Y(n300) );
XNOR2x2_ASAP7_75t_R U311 ( .A(n242), .B(n247), .Y(n244) );
AO322x2_ASAP7_75t_R U312 ( .A1(N228), .A2(n230), .A3(n214), .B1(N96), .B2( N210), .C1(N237), .C2(n138), .Y(n229) );
BUFx12f_ASAP7_75t_R U313 ( .A(n206), .Y(n190) );
BUFx5_ASAP7_75t_R U314 ( .A(n265), .Y(n206) );
O2A1O1Ixp5_ASAP7_75t_R U315 ( .A1(n193), .A2(N183), .B(n179), .C(n277), .Y( n265) );
AO322x2_ASAP7_75t_R U316 ( .A1(N261), .A2(n318), .A3(N219), .B1(N246), .B2( n192), .C1(N201), .C2(n133), .Y(n317) );
NAND2x1p5_ASAP7_75t_R U317 ( .A(N59), .B(N156), .Y(n284) );
OA221x2_ASAP7_75t_R U318 ( .A1(n169), .A2(n313), .B1(n198), .B2(n269), .C( n207), .Y(n301) );
OA221x2_ASAP7_75t_R U319 ( .A1(n169), .A2(n325), .B1(n198), .B2(n273), .C( n207), .Y(n319) );
OA221x2_ASAP7_75t_R U320 ( .A1(n169), .A2(n314), .B1(n198), .B2(n281), .C( n207), .Y(n275) );
XOR2x2_ASAP7_75t_R U321 ( .A(n298), .B(n194), .Y(n302) );
O2A1O1Ixp5_ASAP7_75t_R U322 ( .A1(n234), .A2(n235), .B(n214), .C(n185), .Y( n232) );
NAND2x1p5_ASAP7_75t_R U323 ( .A(N171), .B(n182), .Y(n231) );
AOI22xp5_ASAP7_75t_R U324 ( .A1(n199), .A2(n323), .B1(N237), .B2(n322), .Y( n316) );
AND4x2_ASAP7_75t_R U325 ( .A(N73), .B(n167), .C(n320), .D(N72), .Y(n227) );
NOR3x1_ASAP7_75t_R U326 ( .A(n138), .B(n234), .C(n235), .Y(n247) );
O2A1O1Ixp5_ASAP7_75t_R U327 ( .A1(n234), .A2(n138), .B(n248), .C(n267), .Y( n259) );
XOR2x2_ASAP7_75t_R U328 ( .A(N42), .B(n329), .Y(n326) );
INVx11_ASAP7_75t_R U329 ( .A(N237), .Y(n257) );
O2A1O1Ixp5_ASAP7_75t_R U330 ( .A1(n172), .A2(n257), .B(n197), .C(n211), .Y( n256) );
O2A1O1Ixp5_ASAP7_75t_R U331 ( .A1(n162), .A2(n257), .B(n197), .C(n304), .Y( n303) );
...
O2A1O1Ixp5_ASAP7_75t_R U342 ( .A1(n290), .A2(n291), .B(n175), .C(n152), .Y( n288) );
...
OA33x2_ASAP7_75t_R U354 ( .A1(n326), .A2(n284), .A3(n346), .B1(n343), .B2( n328), .B3(n329), .Y(n272) );
OA211x2_ASAP7_75t_R U355 ( .A1(n213), .A2(n269), .B(n149), .C(n209), .Y(n240) );
AOI22xp5_ASAP7_75t_R U356 ( .A1(n288), .A2(N219), .B1(n289), .B2(N228), .Y( n286) );
...
OAI211xp5_ASAP7_75t_R U368 ( .A1(n197), .A2(n226), .B(n228), .C(n189), .Y( N880) );
AO221x1_ASAP7_75t_R U369 ( .A1(N246), .A2(n174), .B1(N210), .B2(N91), .C( n143), .Y(N879) );
A2O1A1Ixp33_ASAP7_75t_R U370 ( .A1(n174), .A2(N237), .B(n133), .C(N165), .Y( n246) );
OA21x2_ASAP7_75t_R U371 ( .A1(n172), .A2(n212), .B(n196), .Y(n254) );
OAI211xp5_ASAP7_75t_R U372 ( .A1(n136), .A2(n243), .B(n166), .C(n187), .Y( N874) );
...
OAI211xp5_ASAP7_75t_R U377 ( .A1(n298), .A2(n243), .B(n299), .C(n188), .Y( N864) );
OAI211xp5_ASAP7_75t_R U378 ( .A1(n278), .A2(n257), .B(n184), .C(n168), .Y( N863) );
